                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2"  method="post" action=""  enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Public ID<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" autocomplete="off" id="" name="public_id" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo set_value('public_id'); ?>">
                          <span class="fred"><?php echo form_error('public_id'); ?></span>
                        </div>
                      </div>
        						...
        						<div class="form-group">
        							<div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
        							  <a href="<?php echo $url_prefix; ?>balance_history" class="btn btn-primary">Cancel</a>
