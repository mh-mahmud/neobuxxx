                      ...
                      <tbody>
                        <?php foreach($get_record as $v) : ?>
                          <tr class="odd gradeX">
                              ...
                              <td><?php echo "$".$v->PER_SHARE_AMOUNT; ?></td>
                              <td><?php echo $v->TOTAL_SHARE; ?></td>
                              <td><?php echo date("D j S F Y", strtotime($v->CREATED_DATE)); ?></td>
                              <td><?php echo date("g.iA", strtotime($v->BUY_DATETIME)); ?></td>
