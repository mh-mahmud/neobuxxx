                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2"  method="post" action=""  enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Shopping Package Amount<span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select name="share_amount" class="form-control" tabindex="-1">
                            <option value="">--- Select One ---</option>
                            <option value=20>$20 USD</option>
                          </select>
                          <span class="fred"><?php echo form_error('share_amount'); ?></span>
                        </div>
                      </div>
          						...
          						<div class="form-group">
          							<div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
          							  <a href="<?php echo $url_prefix; ?>manage_share" class="btn btn-primary">Cancel</a>
