          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Share Purchase Confirmation</h3>
              </div>
                    ...
                    <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
                      ...
                      <div class="form-group">
                        <div class="col-md-12 col-sm-6 col-xs-12">
                          <div class="new_class" style="margin-left:260px;background-color: #f1f1f1 !important;font-size: 17px;width: 49%;padding: 50px;padding-top: 30px;padding-bottom: 30px;">
                            <p>Per Share Amount: <?php echo $share_amount ?></p>
                            <p>No of Share: <?php echo $no_of_share; ?></p>
                            <p>Total Amount: <?php echo $total_amount; ?></p>
                            <p>Share Expired: <?php echo $share_expire; ?></p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <a href="<?php echo $url_prefix; ?>send_money" class="btn btn-primary">Cancel</a>
