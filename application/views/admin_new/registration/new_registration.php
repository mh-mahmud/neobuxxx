                      ...
                      <tbody>
                        <?php foreach($get_record as $v) : ?>
                          <tr class="odd gradeX">
                              ...
                              <!--<td>-->
                                <?php //if( $this->webspice->permission_verify('new_registration',true) && $v->STATUS==0 ): ?>
                                    <a href="<?php //echo $url_prefix; ?>new_registration/active/<?php //echo $this->webspice->encrypt_decrypt($v->USER_REG_ID,'encrypt'); ?>" class="btn btn-success btn-sm">Active</a>
                              <!--  <?php //endif; ?>-->
                                <?php //if( $this->webspice->permission_verify('new_registration',true)): ?>
                                    <a href="<?php //echo $url_prefix; ?>new_registration/delete/<?php //echo $this->webspice->encrypt_decrypt($v->USER_REG_ID,'encrypt'); ?>" class="btn btn-sm btn-danger">Delete</a>
                                <?php //endif; ?>
                              <!--</td>-->
