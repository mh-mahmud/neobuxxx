                      ...
                      <tbody>
                        <?php foreach($get_record as $v) : ?>
                          <tr class="odd gradeX">
                              ...
                              <td>
                                <?php if( $v->IMAGE && file_exists($this->webspice->get_path('profile_picture_full').$v->IMAGE) ): ?>
                                    <img src="<?php echo $this->webspice->get_path('profile_picture').$v->IMAGE; ?>"  alt="" class="img-responsive" width="150" />
                                <?php endif;  ?>
                              </td>
                              <td>
                                <?php if( $v->NID_FILE && file_exists($this->webspice->get_path('nid_file_full').$v->NID_FILE) ): ?>
                                    <img src="<?php echo $this->webspice->get_path('nid_file').$v->NID_FILE; ?>"  alt="" class="img-responsive" width="150" />
                                <?php endif;  ?>
                              </td>
                              <td><?php echo $v->EMAIL; ?></td>
                              <td><?php echo $this->webspice->enc($v->INIT, 'decrypt') ?></td>
                              ...
                              <td>
                                <?php if( $this->webspice->permission_verify('premium_user',true) && $v->STATUS==0 ): ?>
                                    <a href="<?php echo $url_prefix; ?>premium_user/active/<?php echo $this->webspice->encrypt_decrypt($v->USER_REG_ID,'encrypt'); ?>" class="btn btn-success btn-sm">Active</a>
                                <?php endif; ?>
                                <?php if( $this->webspice->permission_verify('premium_user',true)): ?>
                                    <a href="<?php echo $url_prefix; ?>premium_user/delete/<?php echo $this->webspice->encrypt_decrypt($v->USER_REG_ID,'encrypt'); ?>" class="btn btn-sm btn-danger">Delete</a>
                                <?php endif; ?>
                              </td>
