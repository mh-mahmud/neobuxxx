                      ...
                      <tbody>
                        <?php foreach($get_record as $v) : ?>
                                <tr class="odd gradeX">
                                  ...
                                  <td>
                                    <?php if( $this->webspice->permission_verify('manage_complain',true) && empty($v->FEEDBACK) ): ?>
                                        <a href="<?php echo $url_prefix; ?>manage_complain/reply/<?php echo $this->webspice->encrypt_decrypt($v->COMPLAIN_ID,'encrypt'); ?>" class="btn btn-primary">Reply</a>
                                    <?php endif; ?>
                                  </td>
                                </tr>
                        <?php endforeach; ?>
