              ...
              <?php include(APPPATH."views/admin_new/flash_message.php"); ?>
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <input type="hidden" name="ip_id" value="<?php if( isset($edit['IP_ID']) && $edit['IP_ID']){echo $this->webspice->encrypt_decrypt($edit['IP_ID'], 'encrypt');} ?>" />

            					<div class="form-group">
            						<label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">IP Address<span class="required">*</span>
            						</label>
            						<div class="col-md-6 col-sm-6 col-xs-12">
            						  <input type="text" id="" name="ip_address" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo set_value('ip_address',$this->webspice->enc($edit['IP_ADDRESS'], 'decrypt')); ?>">
            						  <span class="fred"><?php echo form_error('ip_address'); ?></span>
            						</div>
            					</div>
            					...
            					<div class="form-group">
            						...
            						<div class="col-md-6 col-sm-6 col-xs-12">
            						  <input id="birthday" name="expire_date" class="date-picker form-control col-md-7 col-xs-12" required="required" value="<?php echo set_value('expire_date', $this->webspice->enc($edit['EXPIRE_DATE'], 'decrypt')); ?>" type="text">
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <a href="<?php echo $url_prefix; ?>manage_ip_blocking" class="btn btn-primary">Cancel</a>
