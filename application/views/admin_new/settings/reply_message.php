                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2"  method="post" action=""  enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                        ...
                        <div class="form-group">
                          <label class="control-label col-md-3 col-sm-3 col-xs-12" for="reply">Reply Message<span class="required">*</span>
                          </label>
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <textarea id="reply" rows="10" cols="50" name="reply" required="required" class="form-control col-md-7 col-xs-12"></textarea>
                            <span class="fred"><?php echo form_error('reply'); ?></span>
                          </div>
                        </div>
            						...
            						<div class="form-group">
            							<div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
            							  <a href="<?php echo $url_prefix; ?>my_inbox" class="btn btn-primary">Cancel</a>
