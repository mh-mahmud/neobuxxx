          ...
          <div class="">
            ...
            <div class="row">
              ...
              <?php include(APPPATH."views/admin_new/flash_message.php"); ?>
                <div class="x_panel">
                  <div class="x_title">
                    <h2><a class="btn btn-success btn-xs" href="<?php echo $url_prefix; ?>manage_facebook_add"><i class="fa fa-bars"></i> Manage PTC Add</a></h2>
                      ...
                      <input type="hidden" name="package_id" value="<?php if( isset($edit['ADD_ID']) && $edit['ADD_ID'] ){echo $this->webspice->encrypt_decrypt($edit['ADD_ID'], 'encrypt');} ?>" />
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" id="first-name" name="add_name" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $edit_data[0]->ADD_NAME; ?>">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" id="first-name" name="url_1" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $edit_data[0]->URL_1; ?>">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" id="first-name" name="add_duration" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $edit_data[0]->ADD_DURATION; ?>">
                            <span class="fred"><?php echo form_error('add_duration'); ?></span>
                          </div>
                        </div>

                        <?php $i=0; foreach($add_data as $val) : ?>
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="text" id="" name="price_<?php echo $val->PACKAGE_ID; ?>" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $add_value[$i]; ?>">
