          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Withdraw Money Confirmation</h3>
              </div>
            ...
            <div class="row">
              ...
              <?php include(APPPATH."views/admin_new/flash_message.php"); ?>
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Withdraw Money Confirmation</h2>
                    ...
                    <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
                      ...
                      <div class="form-group">
                        <div class="col-md-12 col-sm-6 col-xs-12">
                          ...
                          <div class="new_class" style="margin-left:260px;width: 49%;">
                      ...
                      <?php if($payment_method == 1) : ?>
                        <div class="form-group">
                          <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Enter bKash Number<span class="required">*</span>
                          </label>
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" name="bkash_number" id="" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo set_value('bkash_number'); ?>">
                            <span class="fred"><?php echo form_error('bkash_number'); ?></span>
                          </div>
                        </div>
                      <?php endif; ?>
                      ...
                      <?php if($payment_method == 2) : ?>
                        <div class="form-group">
                          <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Enter Perfect Money Account Number<span class="required">*</span>
                          </label>
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" name="pm_number" id="" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo set_value('pm_number'); ?>">
                            <span class="fred"><?php echo form_error('pm_number'); ?></span>
                          </div>
                        </div>
                      <?php endif; ?>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <a href="<?php echo $url_prefix; ?>balance_withdraw" class="btn btn-primary">Cancel</a>
