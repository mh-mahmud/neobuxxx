          ...
          <div class="">
            ...
            <div class="row">
              ...
              <?php include(APPPATH."views/admin_new/flash_message.php"); ?>
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Approve Withdraw Request</h2>
                    ...
                    <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
                        ...
                        <div class="col-md-12 col-sm-6 col-xs-12">
                          ...
                          <div class="new_class" style="margin-left:260px;width: 49%;">
                            ...
                            <table class="table table-striped table-bordered">
                              ...
                              <tr>
                                <td>Charge Amount:</td>
                                <td><?php echo "$".$charge_amt ?></td>
                              </tr>
                              <tr>
                                <td>Net Withdraw Amount:</td>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="transaction_id" id="" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo set_value('transaction_id'); ?>">
                          <span class="fred"><?php echo form_error('transaction_id'); ?></span>
                        </div>
                      </div>

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Approval Note
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea name="approval_note" class="form-control col-md-7 col-xs-12" rows="5"><?php echo set_value('approval_note'); ?></textarea>
                          <span class="fred"><?php echo form_error('approval_note'); ?></span>
                        </div>
                      </div>
