                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2"  method="post" action=""  enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select name="trans_type" class="form-control" tabindex="-1">
                          <option value="">--- Select One ---</option>
                            <option value="">Select One----</option>
                            <option value="transaction">Payment</option>
                            <option value="return">Return</option>
                          </select>
                          <span class="fred"><?php echo form_error('trans_type'); ?></span>
                        </div>
                      </div>
            					...
            					<div class="form-group">
            						...
            						<div class="col-md-6 col-sm-6 col-xs-12">
            						  <textarea rows="5" name="note" id="" required="required" class="form-control col-md-7 col-xs-12"><?php echo set_value('note'); ?></textarea>
            						  <span class="fred"><?php echo form_error('note'); ?></span>
            						</div>
            					</div>
            					...
            					<div class="form-group">
            						...
            						<div class="col-md-6 col-sm-6 col-xs-12">
            						  <input type="password" name="user_password" id="" required="required" class="form-control col-md-7 col-xs-12" value="">
