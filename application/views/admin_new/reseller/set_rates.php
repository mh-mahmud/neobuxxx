                      ...
                      <tbody>
                        <?php foreach($service_list as $list) : ?>
                          <tr class="odd gradeX">
                            ...
                            <td>
                              <input type="text" class="span12 m-wrap" name="comission[<?php echo $list->SERVICE_ID; ?>]" value="<?php echo set_value(''); ?>">
                            </td>
                            <td>
                              <input type="text" class="span12 m-wrap" name="charge[<?php echo $list->SERVICE_ID; ?>]" value="<?php echo set_value(''); ?>">
                            </td>
                          </tr>
                        <?php endforeach; ?>
                      </tbody>
